...
// Runtime types generated with workerd@1.20260421.1 2026-04-20
declare namespace Cloudflare {
  ...
  interface Env {
    LUVABASE: "no"
    WORKSPACE_DO: DurableObjectNamespace<import("./src/server/worker").WorkspaceDO>
    PAGE_DO: DurableObjectNamespace<import("./src/server/worker").PageDO>
  }
}
